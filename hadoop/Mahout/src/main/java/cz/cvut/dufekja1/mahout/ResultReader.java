 ...
 */
package cz.cvut.dufekja1.mahout;
...
public class ResultReader {
    ...
    public static Map<Integer, String> readMapping(String fileName) throws Exception {
        ...
        while(true) {
            ...
            itemById.put(Integer.parseInt(tokens[0]), tokens[1]);
        }
        return itemById;
    }
        ...
        while(frequentPatternsReader.next(key, value)) {
            ...
            for(Pair<List<String>,Long> pair: patterns) {
                ...
                if (i == 0) {
                    ...
                    firstItemId = (String) itemList.get(0);
                } else {
                    ...
                    if (support > minSupport
                        ...
                        for (String l : listWithoutFirstItem) {
                            if (isFirst){
                                isFirst = false;
                            } else {
                                source += ";";
